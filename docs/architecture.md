...
- CPH4 Labs (CPH4 实验室) — AI research core + FluxVerse future-planning lab（元宙未来规划与发展·2026-09-23 CEO 令），reports to Jason（集团层地址 = `cph4/README.md`，横切研发层）
  ...
  - **BigCompute（硅基算力）— 集团商业化中枢司（2026-09-24 开线·位阶令同日 CEO「商业化子公司的定位高于其他子公司」）**：商业化面位阶高于其他业务司——集团对外成交/定价/粉丝私域/商业渠道的**唯一出口与统辖中枢**（其他司=产能供给方·商业产出经其出口）；承载集团消耗的算力成本，通过现实世界真实链接（抖音小店/直播 Phase 1）商业化消化成本并盈利；确保所有公司互相赋能产生经济价值；九部门全编制（风控/法务/粉丝经营等·「权利第一」）；**护栏**：非审批层（他司司内自治不变·禁官僚化）/跨仓写禁令不变/CEO 保留域与资源倾斜态照旧
